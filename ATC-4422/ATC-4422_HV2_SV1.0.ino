...
// 디지털 출력
    digitalWrite(6,QX00);          // 디지털출력 00
    digitalWrite(7,QX01);          // 디지털출력 01 
    digitalWrite(8,QX02);          // 디지털출력 02 
    digitalWrite(9,QX03);          // 디지털출력 03

 // 아날로그 출력
    analogWrite(10,QW00);          // 아날로그출력 00
    analogWrite(11,QW01);          // 아날로그출력 01
