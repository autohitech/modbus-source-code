 ...
 */
/****************************************************************************
 * This program is for ATC-4422 controller.
...
bool MX00,MX01,MX02,MX03,MX04,MX05,MX06,MX07,MX08;    // 메모리변수
int MW00,MW01,MW02,MW03,MW04,MW05,MW06,MW07,MW08;     // 메모리변수
int i;
...
// 통신속도 설정
bool id1 = !digitalRead(A2);
bool id2 = !digitalRead(A3);
bool id3 = !digitalRead(A4);
bool id4 = !digitalRead(A5);
...
// 디지털 입력 읽기
    IX00 = digitalRead(2);      //마스터 디지털입력 00
    IX01 = digitalRead(3);      //마스터 디지털입력 01
    IX02 = digitalRead(4);      //마스터 디지털입력 02
    IX03 = digitalRead(5);      //마스터 디지털입력 03
...
// 디지털 출력
    digitalWrite(6,QX00);                                    // 마스터 디지털출력 00
    digitalWrite(7,QX01);                                    // 마스터 디지털출력 01 
    digitalWrite(8,QX02);                                    // 마스터 디지털출력 02 
    digitalWrite(9,QX03);                                    // 마스터 디지털출력 03
 ...
 // 아날로그 출력
    analogWrite(10,QW00);                                    // 마스터 아날로그출력 00
    analogWrite(11,QW01);                                    // 마스터 아날로그출력 01
