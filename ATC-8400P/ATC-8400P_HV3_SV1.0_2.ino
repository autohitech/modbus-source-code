/*
 * ATC-8400P_HV3_SV1.0_2    
 * 
 * Model Name : ATC-8400P
 * HardWare Version : 3.0
 * SoftWare Version : 1.0 (측면USB 추가)
...
// 디지털 출력
    digitalWrite(7,!QX00);          // 디지털출력 00
    digitalWrite(6,!QX01);          // 디지털출력 01 
    digitalWrite(5,!QX02);          // 디지털출력 02 
    digitalWrite(4,!QX03);          // 디지털출력 03
