...
//입출력 및 메모리 변수
bool IX00,IX01,IX02,IX03,IX04,IX05,IX06,IX07,IX08,IX09,IX10,IX11;   // 마스터의 디지털 입력변수
...
bool id2 = !digitalRead(A4);
  if (id1 == 0 && id2 == 0 ) {baud_rate = 9600;}
  if (id1 == 1 && id2 == 0 ) {baud_rate = 19200;}
  if (id1 == 0 && id2 == 1 ) {baud_rate = 38400;}
...
// 디지털 입력 읽기
    IX00 = digitalRead(13);      //마스터 디지털입력 00
    IX01 = digitalRead(12);      //마스터 디지털입력 01
    IX02 = digitalRead(11);      //마스터 디지털입력 02
    IX03 = digitalRead(10);      //마스터 디지털입력 03
    IX04 = digitalRead(9);      //마스터 디지털입력 04
    IX05 = digitalRead(8);      //마스터 디지털입력 05
    IX06 = digitalRead(7);      //마스터 디지털입력 06
    IX07 = digitalRead(6);      //마스터 디지털입력 07
    IX08 = digitalRead(5);      //마스터 디지털입력 08
    IX09 = digitalRead(4);      //마스터 디지털입력 09
    IX10 = digitalRead(3);      //마스터 디지털입력 10
    IX11 = digitalRead(2);      //마스터 디지털입력 11
    IX10S = data10[0] & 0x0001;  //슬레이브1 디지털입력 00
    IX11S = data10[0] & 0x0002;  //슬레이브1 디지털입력 01
    IX12S = data10[0] & 0x0004;  //슬레이브1 디지털입력 02
    IX13S = data10[0] & 0x0008;  //슬레이브1 디지털입력 03
    IX20S = data20[0] & 0x0001;  //슬레이브2 디지털입력 00
    IX21S = data20[0] & 0x0002;  //슬레이브2 디지털입력 01
    IX22S = data20[0] & 0x0004;  //슬레이브2 디지털입력 02
    IX23S = data20[0] & 0x0008;  //슬레이브2 디지털입력 03
 ...
 // 아날로그 입력 읽기
   ...
   IW00 = total00 / numReadings00;                   //마스터 아날로그입력 00
   IW01 = total01 / numReadings01;                   //마스터 아날로그입력 01 
...
// 디지털 출력
    digitalWrite(A0,QX00);                                    // 마스터 디지털출력 00
    digitalWrite(A1,QX01);                                    // 마스터 디지털출력 01 
    digitalWrite(A2,QX02);                                    // 마스터 디지털출력 02 
    digitalWrite(A3,QX03);                                    // 마스터 디지털출력 03
